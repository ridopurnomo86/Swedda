...
const LearningMethod = () => (
    <LearningMethodContainer>
        ...
        <Text>
            - You decide for yourself how much time will be used to study this class material.
        </Text>
        <SubTitle>Teaching Facilities</SubTitle>
        <Text>
            - Material will be presented in the form of text and reading Certificate of competence.
        </Text>
    </LearningMethodContainer>
);
